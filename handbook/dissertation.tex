...
This step takes the tokens generated from Lexical analysis and determines if they fit the grammar of a language by attempting to create a parse tree from the tokens, using the languages Context Free Grammar. The resulting tree from this process is called the \textbf{Concrete Syntax Tree}. 
\item []
