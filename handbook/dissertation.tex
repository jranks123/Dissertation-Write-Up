...
\noindent
There has never been a time when more people have wanted to learn how to program. A survey of 140 people that we carried out showed that 40\% of people who do not know how to code would like to learn,


The high-level objective of this project is to create an application that bridges the gap between "drag and drop" visual code-block based educational programs (i.e. Scratch and Tynker) and the typing based interactive educational educational programs,(i.e. CodeAcademy). 
More specifically, the concrete aims are:

\begin{enumerate}
\item Design an interface for programming which allows text based code to be produced via button presses rather than typing. 
\item 
